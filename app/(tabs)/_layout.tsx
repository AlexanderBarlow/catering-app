...
function IOS26LiquidTabBar(props: BottomTabBarProps) {
    ...
    const H_PAD = 10; // padding inside the dock
    const PILL_SIDE_INSET = 8; // pill inset inside each slot
...
export default function TabsLayout() {
    return (
        <Tabs
            ...
            screenOptions={{
                headerShown: false, // keep pages doing their own headers
